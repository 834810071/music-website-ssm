...
public class SongListController {
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            registry.addResourceHandler("/img/songListPic/**").addResourceLocations("file:E:/java_code/music-website/music-server/img/songListPic/");
        }
    }
...
//    更新歌单图片
    ...
    public Object updateSongListPic(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id")int id){
        ...
        //System.out.println(avatorFile.getContentType());
        String fileName = System.currentTimeMillis()+avatorFile.getOriginalFilename();
        String filePath = "E:/java_code/music-website/music-server" + System.getProperty("file.separator") + "img" + System.getProperty("file.separator") + "songListPic" ;
