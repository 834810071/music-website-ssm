...
//    }
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            registry.addResourceHandler("/img/songPic/**").addResourceLocations("file:E:/java_code/music-website/music-server/img/songPic/");
            registry.addResourceHandler("/song/**").addResourceLocations("file:E:/java_code/music-website/music-server/song/");
        }
    }
...
//    添加歌曲
    ...
    public Object addSong(HttpServletRequest req, @RequestParam("file") MultipartFile mpfile){
        ...
        String filePath = "E:/java_code/music-website/music-server" + System.getProperty("file.separator") + "song";
...
//    更新歌曲图片
    ...
    public Object updateSongPic(@RequestParam("file") MultipartFile urlFile, @RequestParam("id")int id){
        ...
        String filePath = "E:/java_code/music-website/music-server" + System.getProperty("file.separator") + "img" + System.getProperty("file.separator") + "songPic";
        File file1 = new File(filePath);
        if (!file1.exists()){
            file1.mkdir();
        }
